...
object UserPaperDetailDao {
  /**
    ...
    * inner join
    * dws_qz_chapter join条件:chapterid 和dn ,
    * inner join
    * dws_qz_course  join条件:sitecourseid和dn ,
    * inner join
    * dws_qz_major join条件majorid和dn,
    * inner join
    * dws_qz_paper 条件paperviewid和dn ,
    * inner join
    * dws_qz_question 条件questionid和
    */
